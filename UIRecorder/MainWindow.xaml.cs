...
namespace JupiterUIRecorder
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void comboBoxRecordedUi_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            textBoxPyCode.Text = selectedItem.GetPyCode(focusedElementName);
        ...
        private void textBoxPyCode_MouseEnter(object sender, System.Windows.Input.MouseEventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(textBoxPyCode.Text))
                textBoxPyCode_ToolTip.Text = textBoxPyCode.Text;
        }
